...
- **날짜·시간 질문**: 홈에 들어오거나 홈을 띄운 채 앱으로 돌아오면 「今日は何月何日ですか」「今、何時何分ですか」 중 하나를 팝업으로 묻습니다. 질문과 정답에는 한자와 숫자를 모두 히라가나로 읽은 줄을 함께 표시합니다. 속으로 답한 뒤 정답을 확인하고, 닫으면 1시간 동안 다시 묻지 않습니다. 설정에서 끌 수 있습니다.
